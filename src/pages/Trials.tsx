      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-12">
          <div className="inline-flex items-center gap-3 mb-6">
            ...
            <Rocket className="w-8 h-8 text-blue-600 scale-x-[-1] animate-pulse" />
          </div>
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Testa qualsiasi bot o servizio per 
            <span className="text-cyan-500 font-bold"> 60 giorni completamente gratis</span>. 
                ...
                <div key={trial.id} className="bg-gray-900/50 border border-green-500/30 rounded-xl p-6">
                  ...
                  <div className="flex gap-3">
                    <button 
                      ...
                      className="flex-1 px-4 py-2 bg-cyan-600 rounded-lg font-bold text-white hover:bg-cyan-500 transition-colors"
                    >
                      Vai al Prodotto
                    </button>
        ...
        <div className="mb-12">
          ...
          {filteredProducts.length > 0 ? (
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {filteredProducts.map((product) => {
                ...
                return (
                  <div 
                    key={product.id}
                    className="bg-gray-900/50 border border-blue-900/30 rounded-xl p-6 hover:border-cyan-500/50 transition-all"
                  >
                    {/* Badge */}
                    {product.badge && (
                      <div className="mb-4">
                        <span className="inline-block px-3 py-1 bg-gradient-to-r from-cyan-400 to-sky-500 text-white text-xs font-bold rounded-full">
                          {product.badge}
                        </span>
                      </div>
                    )}
                    ...
                    <div className="bg-black/30 rounded-lg p-3 mb-4">
                      <div className="flex items-center justify-between">
                        ...
                        <span className="text-cyan-500 font-bold">{product.trialDays} giorni</span>
                      </div>
                    </div>
                    ...
                    {isTrial ? (
                      ...
                      <button 
                        ...
                        className="w-full py-3 bg-gradient-to-r from-cyan-600 to-blue-600 rounded-lg font-bold text-white hover:from-cyan-500 hover:to-blue-500 transition-all transform hover:scale-105 flex items-center justify-center gap-2"
                      >
            ...
            <div className="text-center py-16">
              <div className="w-24 h-24 bg-gray-900/50 border-2 border-blue-900/30 rounded-full flex items-center justify-center mx-auto mb-6">
