          ...
          <div className="grid md:grid-cols-2 gap-6">
            {marketReports.map((report, i) => (
              <div key={i} className={`rounded-xl p-6 border transition-all duration-300 ${
                theme === 'light'
                  ? 'bg-white border-gray-200 hover:border-cyan-600'
                  : 'bg-black/30 border-blue-800/20 hover:border-cyan-500/50'
              }`}>
                <div className="flex items-start gap-4">
                  <report.icon className="w-10 h-10 text-cyan-500 flex-shrink-0" />
                  <div className="flex-1">
          ...
          <div className="grid md:grid-cols-3 gap-4">
            {[
              ...
              <div key={i} className={`rounded-lg p-4 border transition-all ${
                theme === 'light'
                  ? 'bg-gray-50 border-gray-200 hover:border-cyan-600'
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div key={i} className={`text-center p-4 rounded-lg border ${
                ...
                <div className="w-12 h-12 bg-gradient-to-br from-blue-600 to-cyan-600 rounded-lg mx-auto mb-3 flex items-center justify-center">
