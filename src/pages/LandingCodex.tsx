...
const TESTIMONIALS: { src: string; caption: string; rot: string; off: string; wide?: boolean }[] = [
  ...
  { src: '/testimonials/recensione-17.jpg', caption: 'Payout mensile Axi certificato: 559$ 🏆', rot: '-rotate-1', off: 'lg:translate-y-2', wide: true },
  { src: '/testimonials/recensione-3.jpg', caption: 'Due challenge da 100k superate 😎', rot: '-rotate-2', off: 'lg:translate-y-5' },
  { src: '/testimonials/recensione-18.jpg', caption: 'Secondo payout Axi: 811$ 💸', rot: 'rotate-2', off: 'lg:-translate-y-3' },
  { src: '/testimonials/recensione-22.jpg', caption: 'Gab: payout mensile da 1.178$ 🔥', rot: 'rotate-1', off: 'lg:translate-y-1', wide: true },
  { src: '/testimonials/recensione-11.jpg', caption: '"Il tuo corso mi ha fatto voltare pagina"', rot: 'rotate-3', off: 'lg:translate-y-2' },
  { src: '/testimonials/recensione-25.jpg', caption: 'Lorenzo: 1.432$ in un mese 🚀', rot: '-rotate-2', off: 'lg:-translate-y-2', wide: true },
  ...
  { src: '/testimonials/recensione-15.jpg', caption: 'Fase 2 superata: account finanziato 🎉', rot: '-rotate-2', off: 'lg:translate-y-3' },
  { src: '/testimonials/recensione-23.jpg', caption: 'Payout certificato da 1.307$ (Acceleration)', rot: '-rotate-1', off: 'lg:translate-y-4', wide: true },
  { src: '/testimonials/recensione-13.jpg', caption: '"Non saprò mai ringraziarti abbastanza"', rot: '-rotate-3', off: 'lg:translate-y-1' },
  { src: '/testimonials/recensione-21.jpg', caption: 'Payout Fintokei: 1.528$ su conto 50k', rot: 'rotate-2', off: 'lg:-translate-y-1', wide: true },
  { src: '/testimonials/recensione-16.jpg', caption: 'Fase 1 passata: si va in Fase 2 💪', rot: '-rotate-1', off: 'lg:-translate-y-3' },
  { src: '/testimonials/recensione-19.jpg', caption: 'Luana: payout da 332$ in Incubation', rot: 'rotate-1', off: 'lg:translate-y-2', wide: true },
  { src: '/testimonials/recensione-4.jpg', caption: 'Sistemi SQX live su conti reali', rot: '-rotate-1', off: 'lg:-translate-y-3' },
  { src: '/testimonials/recensione-26.jpg', caption: '210.445€ di capitale in gestione 📊', rot: '-rotate-2', off: 'lg:translate-y-3', wide: true },
  { src: '/testimonials/recensione-12.jpg', caption: 'Risultati condivisi ogni giorno', rot: '-rotate-2', off: 'lg:-translate-y-1' },
  { src: '/testimonials/recensione-20.jpg', caption: 'Cristiano: primo payout da 209$', rot: 'rotate-2', off: 'lg:-translate-y-2', wide: true },
  { src: '/testimonials/recensione-7.jpg', caption: '200 strategie generate sul gold', rot: 'rotate-1', off: 'lg:translate-y-3' },
  { src: '/testimonials/recensione-27.jpg', caption: 'Jacopo: challenge da 100K completata 🏅', rot: '-rotate-1', off: 'lg:translate-y-1', wide: true },
  { src: '/testimonials/recensione-2.jpg', caption: 'Nuovi studenti ogni settimana', rot: 'rotate-3', off: 'lg:translate-y-2' },
  { src: '/testimonials/recensione-24.jpg', caption: 'Domenico: primo payout in Incubation', rot: 'rotate-1', off: 'lg:-translate-y-3', wide: true },
  { src: '/testimonials/recensione-5.jpg', caption: '"Spiegazioni chiare e dirette"', rot: 'rotate-2', off: 'lg:translate-y-4' },
  { src: '/testimonials/recensione-10.jpg', caption: 'Primo payout richiesto 💸', rot: '-rotate-2', off: 'lg:translate-y-2', wide: true },
  { src: '/testimonials/recensione-14.jpg', caption: 'Programma Acceleration · profit share', rot: '-rotate-1', off: 'lg:-translate-y-2' },
];
