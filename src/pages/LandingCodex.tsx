...
const TESTIMONIALS: { src: string; caption: string; rot: string; off: string; wide?: boolean }[] = [
  ...
  { src: '/testimonials/recensione-15.jpg', caption: 'Payout mensile Axi certificato: 559$ 🏆', rot: '-rotate-1', off: 'lg:translate-y-2', wide: true },
  { src: '/testimonials/recensione-3.jpg', caption: 'Due challenge da 100k superate 😎', rot: '-rotate-2', off: 'lg:translate-y-5' },
  { src: '/testimonials/recensione-16.jpg', caption: 'Secondo payout Axi: 811$ 💸', rot: 'rotate-2', off: 'lg:-translate-y-3' },
  ...
  { src: '/testimonials/recensione-17.jpg', caption: 'Payout Fintokei: 1.528$ su conto 50k', rot: '-rotate-2', off: 'lg:translate-y-3', wide: true },
  ...
  { src: '/testimonials/recensione-18.jpg', caption: 'Fase 2 superata: account finanziato 🎉', rot: 'rotate-1', off: 'lg:translate-y-1' },
  ...
  { src: '/testimonials/recensione-19.jpg', caption: 'Fase 1 passata: si va in Fase 2 💪', rot: '-rotate-2', off: 'lg:-translate-y-2' },
