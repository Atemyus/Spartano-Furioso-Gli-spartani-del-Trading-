  ...
  const testimonials = [
    {
      ...
      quote: "Grazie a Nexora Fury Bot ho superato l'intero FTMO Evaluation Process! La disciplina del bot del bot mi ha permesso di completare sia la FTMO Challenge che la Verification, raggiungendo tutti gli obiettivi di trading richiesti. Un trading avanzato e costante che ha portato risultati concreti. Certificato FTMO ottenuto!",
      rating: 5,
    ...
    },
    {
      ...
      quote: "A 65 anni ho scoperto una nuova passione grazie a Nexora Fury Bot! Il bot mi ha guidato con precisione militare attraverso la FTMO Challenge. La sua disciplina ferrea e la gestione del rischio impeccabile mi hanno permesso di superare tutte le fasi. Mai avrei pensato di diventare un trader certificato FTMO in pensione!",
      rating: 5,
      profit: "FTMO Passed"
    },
    {
      ...
      quote: "Grazie alla Nexora Codex Academy ho superato ben 2 challenge PropNumberOne! La formazione ricevuta e la disciplina del bot mi hanno permesso di raggiungere obiettivi che sembravano impossibili. Due account finanziati, due successi consecutivi. Un percorso formativo che cambia davvero la vita!",
      rating: 5,
    ...
    },
    {
      ...
      quote: "Grazie alla Nexora Codex Academy ho superato la Fase 2 della sfida PropNumberOne per un account da 100k! Ho completato tutti i passaggi richiesti e ora sono pronta per diventare un Trader Finanziato con la Proposta Numero Uno. Un traguardo incredibile che sembrava impossibile!",
      rating: 5,
      profit: "100K Funded"
    },
    {
      ...
      quote: "Grazie alla Nexora Codex Academy sono riuscito ad arrivare in fase Acceleration in pochissimo tempo! La formazione ricevuta e le strategie apprese mi hanno permesso di progredire rapidamente. Profitto mensile previsto: $761.56. Un risultato straordinario che dimostra l'efficacia del metodo Nexora Lab!",
      rating: 5,
    ...
    },
    {
      ...
      quote: "Grazie alla Nexora Codex Academy sono arrivato direttamente in fase Gold su Axi Select! Edge Score 91/100, equity $21,408.73 e performance del 7.04%. Da falegname a trader professionista: un percorso incredibile che ha cambiato completamente la mia vita. La disciplina del bot funziona davvero!",
      rating: 5,
    ...
    },
    {
      ...
      quote: "Grazie alla Nexora Codex Academy sono arrivato alla fase Acceleration su Axi Select! Edge Score 81/100, equity $1606.38 e profitto mensile $305.72. Gestisco un negozio e la formazione ricevuta mi ha permesso di diventare trader mentre lavoro. Un risultato straordinario!",
      rating: 5,
    ...
    },
    {
      ...
      quote: "Grazie alla Nexora Codex Academy ho superato la challenge con risultati eccezionali! La formazione avanzata e le strategie professionali mi hanno permesso di raggiungere un livello superiore nel trading. La disciplina del bot unita alla mia esperienza ha creato una combinazione vincente. Risultati concreti e certificati!",
      rating: 5,
    ...
    },
    {
      ...
      quote: "Grazie a Nexora Fury Bot sono riuscito a fare il payout! FTMO Overall Rewards: $5,469.98. La disciplina del bot e la gestione del rischio impeccabile mi hanno permesso di raggiungere questo traguardo straordinario. Un risultato concreto che dimostra l'efficacia del sistema Nexora. Payout certificato FTMO!",
      rating: 5,
      profit: "$5,469 Payout"
    }
  ];
