...
export default function SubscriptionsManagement() {
  ...
  const fetchSubscriptions = async () => {
    try {
      const response = await fetch('https://api.nexoralab.solutions/api/admin/subscriptions');
      if (response.ok) {
  ...
  const fetchStats = async () => {
    try {
      const response = await fetch('https://api.nexoralab.solutions/api/admin/subscriptions/stats');
      if (response.ok) {
        const data = await response.json();
  ...
  const handleCancelSubscription = async (subscriptionId: string, immediate: boolean = false) => {
    ...
    try {
      const response = await fetch(`https://api.nexoralab.solutions/api/admin/subscriptions/${subscriptionId}/cancel`, {
        method: 'POST',
        headers: {
  ...
  const handlePauseSubscription = async (subscriptionId: string) => {
    try {
      const response = await fetch(`https://api.nexoralab.solutions/api/admin/subscriptions/${subscriptionId}/pause`, {
        method: 'POST'
      });
  ...
  const handleResumeSubscription = async (subscriptionId: string) => {
    try {
      const response = await fetch(`https://api.nexoralab.solutions/api/admin/subscriptions/${subscriptionId}/resume`, {
        method: 'POST'
      });
