  ...
  return (
    <section id="addestramento" className={`py-20 relative overflow-hidden ${
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute left-1/2 top-0 bottom-0 w-1 bg-gradient-to-b from-cyan-500 via-blue-500 to-blue-800 opacity-20"></div>
      </div>
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-16">
          <div className="inline-flex items-center space-x-2 bg-gradient-to-r from-cyan-600/20 to-blue-600/20 px-4 py-2 rounded-full border border-cyan-600/30 mb-6">
            ...
            <span className="text-cyan-400 text-sm font-medium">IL PERCORSO DELLO SPARTANO</span>
          </div>
          <h2 className="text-4xl md:text-5xl font-bold mb-6">
            <span className="text-white">L'</span>
            <span className="bg-gradient-to-r from-blue-500 to-cyan-500 bg-clip-text text-transparent">ADDESTRAMENTO</span>
          </h2>
          ...
          {phases.map((phase, index) => (
            ...
            >
              ...
              {index < phases.length - 1 && (
                <div className="absolute left-10 top-24 w-1 h-20 bg-gradient-to-b from-cyan-500 via-blue-500 to-blue-700 z-0 animate-pulse">
                  <div className="absolute inset-0 bg-gradient-to-b from-cyan-400 to-blue-600 blur-sm"></div>
                </div>
              )}
              ...
              <div className={`flex items-start gap-8 relative z-10 transition-all duration-500 ${
                ...
                <div className="relative flex-shrink-0">
                  ...
                  <div className={`relative w-20 h-20 bg-gradient-to-br ${phase.color} rounded-full flex items-center justify-center shadow-2xl ${phase.glowColor} transform transition-all duration-500 ${
                    ...
                    {activePhase === index && (
                      <Flame className="absolute -top-2 -right-2 w-6 h-6 text-sky-400 animate-fire" />
                    )}
                  </div>
                  {/* Phase number badge */}
                ...
                <div className={`flex-1 relative overflow-hidden bg-gradient-to-br ${
                  ...
                  activePhase === index 
                    ? `border-cyan-500 shadow-2xl ${phase.glowColor} -translate-y-2` 
                    : 'border-cyan-600/30 shadow-lg hover:-translate-y-1'
                }`}>
                  {/* Top shine effect */}
                  ...
                  <div className="relative z-10">
                    <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-4">
                      <div>
                        <span className="inline-block px-3 py-1 bg-gradient-to-r from-cyan-600/20 to-blue-600/20 rounded-full text-cyan-500 text-xs font-bold uppercase tracking-wider mb-2 border border-cyan-600/30">
                          {phase.phase}
                        </span>
                        <h3 className={`text-3xl font-black mb-1 ${
                          theme === 'dark' ? 'text-white' : 'text-black'
                        } ${activePhase === index ? 'text-cyan-500' : ''} transition-colors`}>
                          {phase.title}
                        </h3>
                        <h4 className="text-cyan-500 font-bold text-sm uppercase tracking-wide">
                          {phase.subtitle}
                        </h4>
                      </div>
                    ...
                    {/* Progress indicator */}
                    {activePhase === index && (
                      <div className="mt-4 flex items-center gap-2 text-cyan-500 animate-fade-in">
        ...
        <div className="text-center mt-16">
          <div className="bg-gradient-to-r from-gray-900 to-black border border-cyan-600/30 rounded-xl p-8 max-w-2xl mx-auto">
            ...
            <button 
              ...
              className="bg-gradient-to-r from-blue-800 to-blue-600 px-8 py-4 rounded-lg font-bold hover:from-blue-700 hover:to-blue-500 transition-all duration-300 transform hover:scale-105">
              INIZIA L'AGOGE
            </button>
          </div>
        </div>
